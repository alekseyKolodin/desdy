...
Элегантная дизайн-система для Android-приложений на Jetpack Compose с "благородной" цветовой палитрой.
...
|-------|-------------|-------------|
| `primary` | Rose600 (#C83D5E) | Rose300 (#F4A9BA) |
| `background` | Neutral50 (#FAF9F7) | Neutral950 (#272624) |
| `surface` | White (#FFFFFF) | Neutral900 (#4A4844) |
| `onPrimary` | White | Rose900 |
| `onSurface` | Neutral900 | Neutral100 |
...
Цветовая палитра построена на "благородных" оттенках:

#### Основные палитры

| Палитра | Описание | Базовый цвет |
|---------|----------|--------------|
| **Rose** (Primary) | Пыльная роза | #C83D5E |
| **Sage** (Secondary) | Шалфейный зелёный | #627750 |
| **Slate** (Tertiary) | Сланцево-синий | #476184 |
| **Neutral** | Тёплый серый | #7D7770 |
